...
<MetaResultFile version="20211011" creator="Solver HFTD - Field 3DFD Monitor">
  ...
  <SimulationProperties fieldname="e-field (f=1.8) [1]" frequency="1.8" encoded_unit="&amp;U:V^1.:m^-1" quantity="e-field" fieldtype="E-Field" fieldscaling="PEAK" dB_Amplitude="20">
    <SecondaryResults>
      <SecondaryResult name="loss (f=1.8)_1.rex"/>
  ...
  <AutoScale>
    ...
    <SmartScaling log_strength="868624" log_anchor="0" log_anchor_type="0" db_range="30"/>
  </AutoScale>
</MetaResultFile>
